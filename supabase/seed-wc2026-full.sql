...
cross join (
  values
    ...
    ('Saksamaa', 'Paraguay', '2026-06-29T20:30:00+00', 'round_32', 1, null, 74, null::int, null::int, 'scheduled'::public.match_status),
    ('Holland', 'Maroko', '2026-06-30T01:00:00+00', 'round_32', 1, null, 75, null::int, null::int, 'scheduled'::public.match_status),
    ('Brasiilia', 'Jaapan', '2026-06-29T17:00:00+00', 'round_32', 1, null, 76, 2, 1, 'finished'::public.match_status),
    ('Prantsusmaa', 'Rootsi', '2026-06-30T21:00:00+00', 'round_32', 1, null, 77, null::int, null::int, 'scheduled'::public.match_status),
    ('Elevandiluurannik', 'Norra', '2026-06-30T17:00:00+00', 'round_32', 1, null, 78, null::int, null::int, 'scheduled'::public.match_status),
    ...
    ('USA', 'Bosnia ja Hertsegoviina', '2026-07-02T00:00:00+00', 'round_32', 1, null, 81, null::int, null::int, 'scheduled'::public.match_status),
    ('Belgia', 'Senegal', '2026-07-01T20:00:00+00', 'round_32', 1, null, 82, null::int, null::int, 'scheduled'::public.match_status),
    ('Portugal', 'Horvaatia', '2026-07-02T23:00:00+00', 'round_32', 1, null, 83, null::int, null::int, 'scheduled'::public.match_status),
    ('Hispaania', 'Austria', '2026-07-02T19:00:00+00', 'round_32', 1, null, 84, null::int, null::int, 'scheduled'::public.match_status),
    ('Šveits', 'Alžeeria', '2026-07-03T03:00:00+00', 'round_32', 1, null, 85, null::int, null::int, 'scheduled'::public.match_status),
    ('Argentina', 'Roheneemesaared', '2026-07-03T22:00:00+00', 'round_32', 1, null, 86, null::int, null::int, 'scheduled'::public.match_status),
    ('Colombia', 'Ghana', '2026-07-04T01:30:00+00', 'round_32', 1, null, 87, null::int, null::int, 'scheduled'::public.match_status),
    ('Austraalia', 'Egiptus', '2026-07-03T18:00:00+00', 'round_32', 1, null, 88, null::int, null::int, 'scheduled'::public.match_status),
    ('Tundmatu', 'Tundmatu', '2026-07-04T21:00:00+00', 'round_16', 1, null, 89, null::int, null::int, 'scheduled'::public.match_status),
    ('Kanada', 'Tundmatu', '2026-07-04T17:00:00+00', 'round_16', 1, null, 90, null::int, null::int, 'scheduled'::public.match_status),

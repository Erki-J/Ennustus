      ...
      <div className="overflow-x-auto border-b border-zinc-100">
        <table className="w-full min-w-[640px] text-left text-xs">
          <thead className="bg-zinc-50 text-zinc-500">
            <tr>
              <th className="whitespace-nowrap px-3 py-2 font-medium">{t("common.question")}</th>
          ...
          <table className="w-full min-w-[900px] text-left text-xs">
            ...
            <tbody>
              <tr className="border-t border-zinc-100 bg-zinc-50 text-zinc-600">
                <td className="sticky left-0 bg-zinc-50 px-3 py-2">{t("common.dash")}</td>
                <td className="sticky left-8 bg-zinc-50 px-3 py-2 font-medium text-zinc-800">
                  {t("overview.resultRow")}
                </td>
                ...
                <td className="px-2 py-2 text-center">{t("common.dash")}</td>
                <td className="px-2 py-2 text-center">{t("common.dash")}</td>

      ...
      <main className="mx-auto max-w-5xl space-y-6 px-4 py-8">
        ...
        {pendingInvites.length > 0 && (
          <section className="rounded-2xl border border-emerald-200 bg-emerald-50 p-6 shadow-sm">
            <h2 className="font-semibold text-zinc-900">{t("dashboard.pendingInvites")}</h2>
                ...
                >
                  <div>
                    ...
                    <p className="mt-1 text-xs text-zinc-500">
                      {t("dashboard.inviteTo", { email: invite.email })}
                    </p>
                  </div>
                  <Link
        ...
        {groups.length === 0 ? (
          <section className="rounded-2xl border border-dashed border-zinc-300 bg-white p-8 text-center">
            <p className="text-zinc-600">{t("dashboard.noGroups")}</p>
            <Link
              href="/groups/new"
